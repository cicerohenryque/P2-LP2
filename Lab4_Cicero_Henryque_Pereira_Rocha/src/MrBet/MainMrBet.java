...
public class MainMrBet {
    ...
    private static void gerirApostas(Scanner scanner) {
        ...
        if(escolha == 'A'){
            ...
            System.out.println(SistemaMrBet.registraAposta(codigoTime, nomeCampeonato, colocacao, valor));
        }

        if(escolha == 'S'){
            System.out.println(SistemaMrBet.imprimeApostas());
        }
    }
    ...
    private static void recuperaTime(Scanner sc) {
        ...
        String retorno = SistemaMrBet.recuperaTime(codigo);
    ...
    private static void criarCampeonato(Scanner sc) {
        ...
        String retorno = SistemaMrBet.criarCampeonato(nomeCampeonato, numParticipantes);
        sc.nextLine();
        System.out.println(retorno);
    }
    ...
    private static void adicionarTimeEmCampeonato(Scanner sc) {
        ...
        if(escolha == 'I'){
            ...
            System.out.println(SistemaMrBet.cadastraTimeEmCampeonato(campeonato, codigo));
            ...
            System.out.println("Campeonato: ");
            String nomeCampeonato = sc.nextLine();
            System.out.println(SistemaMrBet.verificaTimeEmCampeonato(nomeCampeonato, codigoTime));;
        }
    }
    ...
    private static void exibirCampeonatos(Scanner sc) {
        ...
        String campeonatosDoTime = SistemaMrBet.exibeCampeonatos(nomeTime);
    ...
    private static void criarTime(Scanner sc) {
        ...
        String statusCriacao = SistemaMrBet.criarTime(codigo, nome, mascote);
